...
with(february, plot(DateAndTime, Voltage, type="l", xlab="datetime", ylab="Voltage"))
with(february, plot(DateAndTime, Sub_metering_1, type="l", col="black", xlab=" ", ylab="Energy sub metering"))
lines(february$DateAndTime, february$Sub_metering_2, type="l", col="red")
lines(february$DateAndTime, february$Sub_metering_3, type="l", col="blue")
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=1, lwd=2, col=c("black", "red", "blue"))
with(february, plot(DateAndTime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()
